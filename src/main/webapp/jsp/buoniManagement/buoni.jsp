...
<%--
    Document   : buoni
    Created on : 23-lug-2024, 14.26.15
...
<%
    ...
    int numBuoni = (buoni != null) ? buoni.size() : 0;
...
<main>
    <div class="nomeBuono" style="margin-bottom: 15px;">
        <p>Benvenuto <%= (ul != null) ? ul.getNomeUtente() : "Utente" %> <%= (ul != null) ? ul.getCognome() : "" %></p>
    </div>
    ...
    <section>
        ...
        <% if (mod != null && mod.equals("NomeBuono")) { %>
    ...
    <section id="box" class="clearfix">
        <!-- Controllo se non ci sono buoni -->
        <% if (numBuoni == 0) { %>
        <p>Nessun buono disponibile al momento.</p>
        <% } else { %>
