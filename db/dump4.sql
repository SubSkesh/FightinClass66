...
CREATE TABLE `pagamento` (
  ...
  `codicePagamento` varchar(50) DEFAULT NULL,
  `importo` decimal(10,2) DEFAULT NULL,
  `utenteId` int DEFAULT NULL,
  `ordineId` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_codicePagamento` (`codicePagamento`),
  KEY `utenteId` (`utenteId`),
  KEY `ordineId` (`ordineId`),
...
CREATE TABLE `prodotto` (
  ...
  `codiceProdotto` varchar(50) DEFAULT NULL,
  `prezzo` decimal(10,2) DEFAULT NULL,
  `blocked` tinyint(1) DEFAULT NULL,
  `push` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `prodotto_pk` (`codiceProdotto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-28 11:41:20
